        ...
        <section class="flex flex-col gap-[30px] mt-[30px] px-5">
            ...
            <section class="flex flex-col gap-5">
                ...
                <div class="info-card flex flex-col gap-2">
                    ...
                    <div class="flex items-center rounded-2xl p-[18px_14px] gap-3 bg-[#F4F4F6]">
                        ...
                        <div class="flex flex-col gap-1">
                            <p class="font-semibold">Jalan nayapati bandung utara nomor 12, cekelong, jawa barat 1103</p>
                        </div>
                    </div>
                </div>
                @endif
            ...
            <div id="Payment-details" class="flex flex-col gap-3">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="flex items-center justify-between">
                        <p>Grand total</p>
                        <p class="font-bold text-xl leading-[30px] underline">{{number_format($details->total_amount, 0, ',', '.')}}</p>
                    </div>
                </div>
            </div>
        </section>
