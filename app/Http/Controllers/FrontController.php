...
class FrontController extends Controller
{
    ...
    public function booking_save(StoreBookRequest $request, Product $product)
    {
    ...
    public function checkout_store(StorePaymentRequest $request)
    {
        ...
        if (!$productDetails) { // Jika produk tidak ditemukan
        ...
        DB::transaction(
            function () use ($request, &$bookingTransactionId, $duration, $bookingData, $grandTotal, $productDetails, $startedDate,) {
    ...
    public function transaction_details(Request $request)
    {
        ...
        if (!$details) {
            return redirect()->back()->withErrors(['trx_id' => 'Transaction not found']);
        }
